...
def create_alarm_with_repeat(repeat_days: str, time: str, name: str = 'None', does_repeat: bool = True):
    ...
    :param name: (str) name of the alarm
...
if __name__ == '__main__':
    print(create_alarm_with_repeat(repeat_days='Monday Tuesday Wednesday Friday', time='06:59'))
    # print(create_alarm_no_repeat(time='01:00', non_repeat_date=(datetime.now())))