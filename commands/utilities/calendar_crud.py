...
def create_google_calendar_event(start_time: time, start_date: datetime, end_time: time, end_date: datetime,
    ...
    :param color_id: the id of the color of the event
...
def unit_test_create_google_calendar_event(start_time: time, start_date: datetime, end_time: time,
                                           ...
                                           description: str, timezone_upload: str, color_id: str| None = None):
    """
...
@log_exceptions
def edit_calendar_event(event_id: int, summary: str | None = None, description: str | None = None,
                        start_time: datetime | None = None, end_time: datetime | None = None) -> dict:
    """
