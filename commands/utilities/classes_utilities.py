...
class alarms:
    ...
    @staticmethod
    def save(data):
        logger = create_logger_error(os.path.abspath(__file__), 'alarm.save')

        query = 'INSERT INTO alarms (end_time, name, added, updated, does_repeat, repeat_days, non_repeat_date) VALUES (%(end_time)s, %(name)s, %(added)s, %(updated)s, %(does_repeat)s, %(repeat_days)s, %(non_repeat_date)s);'
    ...
    @staticmethod
    def select_all():
        logger = create_logger_error(os.path.abspath(__file__), 'alarm.select_all')
    ...
    @staticmethod
    def delete(data):
        logger = create_logger_error(os.path.abspath(__file__), 'alarm.delete')
...
class lights:
    ...
    @staticmethod
    def save(data):
        logger = create_logger_error(os.path.abspath(__file__), 'lights.save')

        query = 'INSERT INTO lights ( on_off, lights_color, lights_brightness, does_repeat, repeat_days, time, non_repeat_date, added, updated) VALUES (%(on_off)s, %(lights_color)s, %(lights_brightness)s, %(does_repeat)s, %(repeat_days)s, %(time)s, %(non_repeat_date)s, %(added)s, %(updated)s);'
    ...
    @staticmethod
    def select_all():
        logger = create_logger_error(os.path.abspath(__file__), 'lights.select_all')
    ...
    @staticmethod
    def delete(data):
        logger = create_logger_error(os.path.abspath(__file__), 'lights.delete')
...
class reminders:
    ...
    @staticmethod
    def save(data):
        logger = create_logger_error(os.path.abspath(__file__), 'reminders.save')

        query = 'INSERT INTO reminders (end_time, reminder, to_say, added, updated, does_repeat, repeat_days, non_repeat_date) VALUES (%(end_time)s, %(reminder)s, %(to_say)s, %(added)s, %(updated)s, %(does_repeat)s, %(repeat_days)s, %(non_repeat_date)s);'
    ...
    @staticmethod
    def select_all():
        logger = create_logger_error(os.path.abspath(__file__), 'reminders.select_all')
    ...
    @staticmethod
    def delete(data):
        logger = create_logger_error(os.path.abspath(__file__), 'reminders.delete')
...
class tasks:
    ...
    @staticmethod
    def save(data):
        logger = create_logger_error(os.path.abspath(__file__), 'tasks.save')

        query = f'INSERT INTO tasks (due_date, task_name, description, priority, status, added, updated) VALUES (%(due_date)s, %(task_name)s, %(description)s, %(priority)s, %(status)s, %(added)s, %(updated)s);'
    ...
    @staticmethod
    def select_all():
        logger = create_logger_error(os.path.abspath(__file__), 'tasks.select_all')
    ...
    @staticmethod
    def delete(data):
        logger = create_logger_error(os.path.abspath(__file__), 'tasks.delete')
...
class habit:
    ...
    @staticmethod
    def save(data):
        logger = create_logger_error(os.path.abspath(__file__), 'habit.save')

        query = f'INSERT INTO habit (name, due_time, done_for_day, priority, added, updated, repeat_days, reminded) VALUES (%(name)s, %(due_time)s, %(done_for_day)s, %(priority)s, %(added)s, %(updated)s, %(repeat_days)s, False);'
