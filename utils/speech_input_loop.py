...
async def main():
    ...
    model2 = model + ".en"
    model = "F:\\Coding\\Iris_V2\\data\\models\\" + model2
    torch.cuda.init()
    device = 'cuda'
            ...
            if not data_queue.empty():
                ...
                for line in transcription:
                    ...
                    if line == 'Thank You.' or line == 'Thanks for watching!':
                        # don't print if its Thank YOu. or Thanks for watching!, when it doesn't know if anything is being said it will likley print out either of these
                        break
                    else:
                        print(line)
